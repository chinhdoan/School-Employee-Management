...
public class AdminEditInfor1 extends JFrame {
	Connection con = null;
	ResultSet rs = null;
	...
	private void initComponents() {
		...
		jTextField12.setText("nhan vien hanh chinh");
		jLabel6 = new JLabel();
		...
		jLabel10 = new JLabel();
		jLabel10.setText("Money Support");
	...
	private void jTextField1KeyReleased(KeyEvent evt) {// GEN-FIRST:event_jTextField1KeyReleased
		...
		try {
			...
			while (rs.next()) {
				...
				String add7 = rs.getString("workdays_number");
				jTextField7.setText(add7);
				String add5 = rs.getString("salary_factor");
				jTextField8.setText(add5);
				String add8 = rs.getString("money_support");
		...
		// TODO add your handling code here:
				try {
					...
					while (rs.next()) {
						...
						String add6 = rs.getString("workdays_number");
						jTextField7.setText(add6);
						String add7 = rs.getString("salary_factor");
		...
		if (jTextField1.getText().equals("")) {
			...
			if (p == 0) {
				try {
					...
					String sql = "update test3 set worker_id='" + value1 + "',name='" + value2 + "', birth_day='"
							+ value3 + "', " + "home_town='" + value4 + "',department='" + value5 + "',workdays_number='"
							+ value6 + "',salary_factor='" + value7 + "',money_support= '" + value8 + "', " + "position='" + value9
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(AdminEditInfor1.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
