...
public class AdminAddingInfor extends JFrame {
	public static void main(String[] args) {
		new AdminAddingInfor();
	...
	public AdminAddingInfor() {
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AdminEditInfor av = new AdminEditInfor();
				av.setVisible(true);
				dispose();
			}
		});
					...
					try {
						...
						JOptionPane.showConfirmDialog(null, "Are you sure Insert Data?", "Delete",
						 ...
						 pstm = con.prepareStatement(
								"INSERT INTO test1 (worker_id,name,birth_day,home_town,specialty,"
										+ "degree,money_support,period_working_number,salary_factor,working_years,type)"										
										+ "VALUES(?,?,?,?,?,?,?,?,?,?,?)");
