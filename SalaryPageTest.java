...
public class SalaryPageTest extends JFrame {
	Connection con = null;
	ResultSet rs = null;
	...
	private void initComponents() {
			...
			jPanel1Layout.createParallelGroup(Alignment.TRAILING)
				.addGroup(jPanel1Layout.createSequentialGroup()
					...
					.addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING)
						.addComponent(jButton2, GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
						.addComponent(jButton3, GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
						.addComponent(jButton4, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
						.addComponent(jButton5, GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
						.addComponent(jButton7, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE))
					.addGap(18)
		...
		layout.setHorizontalGroup(
			layout.createParallelGroup(Alignment.LEADING)
				...
				.addComponent(jPanel1, GroupLayout.PREFERRED_SIZE, 1240, Short.MAX_VALUE)
		);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(SalaryPageTest.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new SalaryPageTest().setVisible(true);
			}
		});
	}
