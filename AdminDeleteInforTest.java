...
public class AdminDeleteInforTest extends JFrame {
	...
	public static void main(String args[]) {
		try {
			...
			java.util.logging.Logger.getLogger(AdminDeleteInforTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new AdminDeleteInforTest().setVisible(true);
