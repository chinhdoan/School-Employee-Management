...
public class AdminViewInfor2 extends JFrame {
	...
	private void SearchingKeyReleasedDOB(KeyEvent arg1) {// GEN-FIRST:event_textFieldKeyReleased
		...
		try {
			...
			String sql3 = "select * from test3 where birth_day Like ?";
	...
	public static void main(String args[]) {
		try {
			...
			java.util.logging.Logger.getLogger(AdminViewInfor2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new AdminViewInfor2().setVisible(true);
