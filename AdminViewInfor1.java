...
public class AdminViewInfor1 extends JFrame {
	...
	private JLabel lblDobSearch;

	public AdminViewInfor1() {
	...
	private void initComponents() {
			...
			jPanel2Layout.createParallelGroup(Alignment.TRAILING)
				.addGroup(jPanel2Layout.createSequentialGroup()
					...
					.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(jButton2, GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE))
					.addGap(18)
					.addComponent(jScrollPane1, GroupLayout.PREFERRED_SIZE, 997, GroupLayout.PREFERRED_SIZE))
		);
		...
		btnEdit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				AdminEditInfor2 a = new AdminEditInfor2();
				a.setVisible(true);
				dispose();
			}
		});
			...
			layout.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(layout.createSequentialGroup()
					...
					.addGroup(layout.createParallelGroup(Alignment.TRAILING)
						.addComponent(btnEdit, GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE)
						.addComponent(jButton3, GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE)
						.addComponent(btnAdd, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE))
					.addGap(54)
					.addGroup(layout.createParallelGroup(Alignment.TRAILING)
						.addGroup(layout.createSequentialGroup()
	...
	private void SearchingKeyReleasedDOB(KeyEvent arg1) {// GEN-FIRST:event_textFieldKeyReleased
		...
		try {
			...
			String sql3 = "select * from test2 where birth_day Like ?";
	...
	public static void main(String args[]) {
		try {
			...
			java.util.logging.Logger.getLogger(AdminViewInfor1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new AdminViewInfor1().setVisible(true);
